...
freeswitch.consoleLog("NOTICE", "xml_handlers/dialplan/handler.lua called\n")
...
freeswitch.consoleLog("DEBUG", "Context: " .. context .. "\n")
freeswitch.consoleLog("DEBUG", "Destination: " .. destination .. "\n")
...
freeswitch.consoleLog("DEBUG", "SQL query: " .. query .. "\n")
