--[[
    ...
    Enrutador de secciones XML para FreeSWITCH.
    Invoca scripts específicos según la sección solicitada.
--]]
...
elseif section == "configuration" then
    ...
    elseif config_name == "ivr.conf" then
        -- Load the IVR handler script and pass settings as an argument
        log("INFO", "Manejando configuración ivr.conf")
    ...
    elseif config_name == "timezones.conf" then
        ...
        -- Log a warning if the configuration is not recognized
